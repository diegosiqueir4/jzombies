...
public class JZombiesBuilder implements ContextBuilder<Object> {
	...
	//	int humanCount = (Integer) params.getValue("human_count");
		...
		//iterates through the all agents in the context, retrieves each one’s location in the ContinuousSpace and moves it to the corresponding location in the Grid
